...
export const SHOP_SIGNS: readonly ShopSign[] = [
  { id: "store", name: "祐記士多", touch: { x: 304, y: 260 }, hint: "招牌「祐記士多」：便利店门口" },
  { id: "coffee", name: "海風咖啡", touch: { x: 408, y: 260 }, hint: "招牌「海風咖啡」：咖啡室门口" },
  { id: "tea", name: "德興茶樓", touch: { x: 508, y: 180 }, hint: "竖招牌「德興茶樓」：茶楼沿墙北上" },
  { id: "bank", name: "濠江銀號", touch: { x: 576, y: 88 }, hint: "招牌「濠江銀號」：终点就在门前" },
  { id: "pet", name: "貓記寵物", touch: { x: 562, y: 140 }, hint: "竖招牌「貓記寵物」：宠物店外墙" },
  { id: "pawn", name: "同德按", touch: { x: 562, y: 236 }, hint: "圆形押店招牌「同德按」" },
  { id: "tart", name: "燈塔葡撻", touch: { x: 304, y: 308 }, hint: "招牌「燈塔葡撻」：兰挞店在南侧" },
  { id: "bakery", name: "安記餅家", touch: { x: 448, y: 308 }, hint: "招牌「安記餅家」：饼香从南侧传来" },
] as const;
...
export const OLD_CITY_TILEMAP: TileMapDefinition = {
  ...
  decorations: [
    ...
    { kind: "shop-sign", x: 304, y: 210, width: 68, height: 20, depth: 261, label: "祐記士多" },
    { kind: "shop-sign", x: 408, y: 210, width: 68, height: 20, depth: 261, label: "海風咖啡" },
    { kind: "shop-sign", x: 506, y: 196, width: 20, height: 64, depth: 261, label: "德興茶樓", signVertical: true },
    // 东北角银行（终点后方）。
    { kind: "corner-house", x: 580, y: 84, width: 110, height: 78 },
    { kind: "shop-sign", x: 576, y: 36, width: 68, height: 20, depth: 86, label: "濠江銀號" },
    ...
    { kind: "shop-sign", x: 566, y: 196, width: 20, height: 64, depth: 197, label: "貓記寵物", signVertical: true },
    ...
    { kind: "shop-sign", x: 304, y: 320, width: 68, height: 18, depth: 357, label: "燈塔葡撻" },
    { kind: "low-house", x: 448, y: 356, width: 92, height: 62, flipX: true },
    { kind: "shop-sign", x: 448, y: 320, width: 68, height: 18, depth: 357, label: "安記餅家" },
