...
export const TIP_DEFINITIONS: Record<TipId, TipDefinition> = {
  "sighted-guide": {
    ...
    title: "扶盲方法",
    heading: "让盲人握住你的手臂",
    summary: "先征求同意，再让盲人主动握住你的肘部或肩膀，并把你看到的路况说清楚。",
    image: sightedGuideTutorialUrl,
    imageAlt: "暖灰像素插图：工作人员先征求同意，盲人主动握住引导者肘部，随后在引导者侧后方半步随行",
    steps: [
      { title: "先询问", body: "说清身份和要提供的帮助，得到同意后再接触。" },
      { title: "递手臂", body: "轻触手背或把手臂靠近，让盲人主动握住你的肘部或肩膀；引导者领先半步。" },
  ...
  "guide-dog-access": {
    ...
    steps: [
      ...
      { title: "购买困难", body: "没有正式的引进渠道，视障者难以独立完成。" },
